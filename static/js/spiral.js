...
//Code based on Condegram Spiral Plot by Arpit Narechania https://bl.ocks.org/arpitnarechania/027e163073864ef2ac4ceb5c2c0bf616
  ...
  //	console.log(val);
    ...
    .on('mousemove', function(d) {
        ...
        .on('click',function(d) {
            ...
            drawLine(gLine,lineHeight,lineWidth,lineData,monthYear,color(d.group));
